...
{
// constants 
const string customerName = “Jane Smith” , userName = “jsmith” , password = “blue123” , accountNumber = “123456789” , memberLevel = “Gold” , address = “100 W New Haven Ave, Melbourne, FL 32901”;
...
if (i_username == username && i_password == password)
{
	...
	cout << left << setw(10) << “SKU” << left << setw(20) << “Name” << “Items in Unit”	<< “Price per Unit” << “Quantity on Hand” << endl;
...
{
	cout << left << setw(10) << SKU[i] << left << setw(20) << name[i] << itemsinUnit[i] 	<< priceperUnit[i] << quantityonHand[i] << endl;
}
...
{
	cout << “Error! No quantity detected; the number of items must be entered before 	continuing. Please try again or exit the program” endl;
}
else
{
	total = i_quantity * priceperUnit[itemStock];
...
cout << left << setw(20) << “Items in Unit:” << right << setw(10) << iteminUnit[itemStock] << endl;
cout << left << setw(20) << “Price:” << right << setw(9) << “$” << priceperUnit[itemStock] << endl;
...
cout << left << setw(20) << “Remaining Store Credit” << right << setw(9) << “$” << storeCredit << endl;
